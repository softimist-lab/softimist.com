  ...
  return (
    <div
      className={cn(
        ...
        open
          ? 'pointer-events-auto opacity-100 -translate-x-1/2 translate-y-0 scale-100 animate-[mega-enter_200ms_cubic-bezier(0.16,1,0.3,1)_both]'
          : 'pointer-events-none opacity-0 -translate-x-1/2 translate-y-1.5 scale-[0.98] animate-[mega-exit_150ms_ease_both]',
      )}
